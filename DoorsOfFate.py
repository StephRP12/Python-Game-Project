...
#particular decision has triggered another action. The user could win, lose, restart, or have a setback and have to make up to 3 additional choices. At the end of 10 choices, the
#game will determine the user's fate based on the choices made. The game will be implemented using Python and will be run in the terminal.
